    ...
    return {
        ...
        link: function(scope, element) {
            ...
            function updateRect(position, width, height, apply) {
                ...
                selector.p_x1 = selector.x1 / width;
                selector.p_y1 = selector.y1 / height;
                selector.p_x2 = selector.x2 / width;
                selector.p_y2 = selector.y2 / height;
            ...
            function clear() {
                ...
                selector.p_x1 = selector.p_x2 = selector.p_y1 = selector.p_y2 = undefined;
